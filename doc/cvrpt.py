...
def main():
    ...
    print('Route 0:')
    for i, j in [[0, 5], [5, 8], [8, 6], [6, 2], [2, 0]]:
        print('transit time {i}->{j}: {value}'.format(
            i=i,
            j=j,
            value=time_evaluator(i, j)))

    print('Route 1:')
    for i, j in [[0, 9], [9, 14], [14, 16], [16, 10], [10, 0]]:
        print('transit time {i}->{j}: {value}'.format(
            i=i,
            j=j,
            value=time_evaluator(i, j)))
    ...
    print('Route 2:')
    for i, j in [[0, 12], [12, 13], [13, 15], [15, 11], [11, 0]]:
        print('transit time {i}->{j}: {value}'.format(
            i=i,
            j=j,
            value=time_evaluator(i, j)))
    ...
    print('Route 3:')
    for i, j in [[0, 7], [7, 4], [4, 3], [3, 1], [1, 0]]:
        print('transit time {i}->{j}: {value}'.format(
            i=i,
            j=j,
            value=time_evaluator(i, j)))
